const PAST_ROLES: {
  ...
  endDate: string
    ...
    },
    {
      ...
      description:
        'Built and maintained scalable web applications for retail and POS operations — including multi-user MLM platforms and payment gateway integrations. Owned complex database queries, performance tuning, and pre-release testing to keep transaction-heavy systems dependable in production.',
      startDate: 'October 2020',
      endDate: 'November 2021',
    },
    {
      company: 'Lembah Indah Malang',
      country: 'Indonesia',
      role: 'Web Developer',
      description:
    ...
    },
    {
      ...
      role: 'Software Engineer',
      description:
        'Contributed to the hospital\'s digital presence across the full development lifecycle — analysis, build, testing, deployment, and support. Delivered scalable web solutions aimed at improving access to hospital services for patients and staff.',
      startDate: 'June 2018',
      endDate: 'August 2018',
    },
  ]
